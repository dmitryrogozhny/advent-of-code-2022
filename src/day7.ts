 ...
 */
function findFolders(folder: Folder, matchingFolders: Folder[], condition: (folder: Folder) => boolean) {
    if (condition(folder)) {
...
function addFolder(folder: Folder, parent: Folder) {
    if (parent.subFolders.find((f) => f.name === folder.name)) {
...
function addFile(file: File, parent: Folder) {
